...
def match(match_id):
    ...
    guest_access_token = user_data[user_data["user_id"] == guest]["access_token"].iloc[0]
    ...
    return jsonify({ "host": host_data.to_dict(), "guest": guest_data.to_dict(), "match": comparison} )
